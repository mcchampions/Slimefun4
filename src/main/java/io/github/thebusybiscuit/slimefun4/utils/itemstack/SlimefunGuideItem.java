...
public class SlimefunGuideItem extends ItemStack {
    ...
    public SlimefunGuideItem(@Nonnull SlimefunGuideImplementation implementation, @Nonnull String name) {
        ...
        lore.add(type == SlimefunGuideMode.CHEAT_MODE ? TextUtils.translateAlternateColorCodes("&4&l仅限管理员使用") : "");
        lore.add(TextUtils.translateAlternateColorCodes("&e右键 &8\u21E8 &7浏览物品"));
        lore.add(TextUtils.translateAlternateColorCodes("&eShift + 右键 &8\u21E8 &7打开 设置 / 关于"));
