...
public abstract class AbstractEnergyProvider extends SlimefunItem
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (MachineFuel fuel : fuelTypes) {
            ...
            lore.add(TextUtils.translateAlternateColorCodes("&8\u21E8 &7持续时间 " + NumberUtils.getTimeLeft(fuel.getTicks() / 2)));
            lore.add(TextUtils.translateAlternateColorCodes("&8\u21E8 &e\u26A1 &7" + (getEnergyProduction() << 1)) + " J/s");
            lore.add(TextUtils.translateAlternateColorCodes("&8\u21E8 &e\u26A1 &7最大储存量: "
