...
public final class PostSetup {
    ...
    public static void loadItems() {
        ...
        sender.sendMessage("");
        sender.sendMessage(ChatColor.GREEN + " - 源码:      https://github.com/mcchampions/Slimefun4");
        sender.sendMessage(ChatColor.GREEN + " - Bug 反馈:  https://github.com/mcchampions/Slimefun4/issues");
